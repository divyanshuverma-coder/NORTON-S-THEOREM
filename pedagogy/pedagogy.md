...
7.|Student will select  the answer |simulator will show further instruction saying "To calculate R<sub>N</sub> first short circuit the load resistance by clicking on undo button".| 
